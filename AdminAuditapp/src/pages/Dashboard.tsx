...
export default function Dashboard() {
  ...
  const fetchAllEmployees = async () => {
    try {
      ...
      setAllEmployees(
        users.map((u: { UserId?: number; Id?: number; FullName?: string; fullName?: string; UserCode?: string; userCode?: string; WorkPosition?: string }) => ({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedTerritories, dateFilter, selectedDate, selectedMonth, selectedEmployee, selectedWeek, selectedWorkPosition]);
